...
class Right extends Component {
    ...
    render() {
        ...
        return (
            <div className={`svg_right ${(this.state.cursor_left && `rotate_left`) || (this.state.cursor_center && `rotate_center`) || (this.state.cursor_right && `rotate_right`)}`} style={style_right}>
