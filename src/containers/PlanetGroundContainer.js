...
class PlanetGroundContainer extends Component{
    ...
    point_set = () => {
        ...
        let points_arr1, points_arr2, points_arr3 = [];
        ...
        // points_push = (x_data, y_data, type_data) =>{
        //     points_arr.push({x : x_data, y : y_data, type : type_data});
        // }
        ...
        // switch(data.id){
        //     case 1 :
        //         points_push(118, 232, 't');
        //         points_push(400, 517, 't');
        //         t += 2;
        //         points_push(266, 42, 'a');
        //         points_push(387, 227, 'h');
        //         points_push(349, 315, 'h');
        //         points_push(229, 516, 'a');
        //         points_push(554, 351, 'a');
        //         break;
        //     case 2 :
        //         break;
        //     case 3 :
        ...
        return(
            <div className={`groundContainer ground`+(data.id+1)}>
                ...
                <div className='dataPoints'>
                    <div id='data_hominidae_view'>test</div>
                    <svg viewBox='0 0 600 600'>
                        <circle className='data_hominidae' cx={data.id} cy='50' r='5' fill='#fff' />
                        {this.point_set()}
                    </svg>
                </div>
                <svg viewBox='0 0 600 600'>
